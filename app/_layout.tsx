...
import toastConfig from "./features/Toast/toastConfig";
  ...
  return (
    <>
      <Stack>
        ...
        <Stack.Screen name="features/Intro/index" options={{ headerShown: false }} />
        <Stack.Screen name="features/Login/index" options={{ headerShown: false }} />
        <Stack.Screen name="features/Cadastro/index" options={{ headerShown: false }} />
